...
export const Navbar: Component = () => {
  ...
  return (
    <header class="navbar pointer-events-none fixed top-0 z-50 justify-end">
      <ul
        class="navbar-end max-lg:bg-primary/90 bg-primary/40 hover:bg-primary/90 pointer-events-auto flex items-center justify-end rounded-lg transition-all"
        classList={{ 'w-14': !expanded(), 'w-28': expanded() }}
      >
