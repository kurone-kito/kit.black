...
// `data.json` is generated by `prebuild:fetcher`, which needs live Google
// Calendar API credentials -- not available in a fresh worktree/CI-less
// context, so this suite is a known, separate gap outside
// `pre-push-validate`'s scope (see docs/idd-policy.md's Project Commands
// section and #208).
