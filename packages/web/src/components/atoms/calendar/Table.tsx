...
export const Table: Component<Readonly<ParentProps>> = (props) => (
  <table class="table-xs table w-full border-separate border-spacing-x-0.5 border-spacing-y-1 sm:border-spacing-y-1.5 sm:pr-[10%] md:border-spacing-x-1.5 md:pr-[15%] lg:border-spacing-0.5 lg:pr-0 [&_*]:whitespace-nowrap [&_*]:text-nowrap [&_*]:break-keep [&_*]:text-[2.3cqi] lg:[&_*]:text-[1.9cqi]">
    ...
    <thead class="[&_th]:bg-base-300/80 [&_th]:rounded-full [&_th]:p-[1cqi]">
    ...
    <tbody class="[&_.release]:!bg-secondary/80 [&_.release]:text-secondary-content [&_.streaming]:!bg-accent/80 [&_.streaming]:text-accent-content [&_td]:bg-base-300/80 [&_.date]:text-center [&_.sat]:!bg-blue-500/60 [&_.sun]:!bg-red-500/60 [&_.time]:text-center [&_td]:rounded-full [&_td]:px-[2cqi] [&_td]:py-[1.8cqi]">
      {props.children}
    </tbody>
  </table>
);
